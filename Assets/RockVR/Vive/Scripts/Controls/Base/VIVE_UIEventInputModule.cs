...
namespace RockVR.Vive
{
    ...
    /// </summary>
    public class VIVE_UIEventInputModule : PointerInputModule
    {
        public List<VIVE_Pointer> pointers;

        public void Initialise()
        {
            pointers = new List<VIVE_Pointer>();
        }
        ...
        private List<RaycastResult> CheckRaycasts(VIVE_Pointer pointer)
        {
        ...
        private bool NoValidCollision(VIVE_Pointer pointer, List<RaycastResult> results)
        {
            return (results.Count == 0 || !CheckTransformTree(results[0].gameObject.transform, pointer.pointerEventData.pointerEnter.transform));
        }

        private bool IsHovering(VIVE_Pointer pointer)
        {
        ...
        private void Hover(VIVE_Pointer pointer, List<RaycastResult> results)
        {
        ...
        private void Click(VIVE_Pointer pointer, List<RaycastResult> results)
        {
        ...
        private void Drag(VIVE_Pointer pointer, List<RaycastResult> results)
        {
